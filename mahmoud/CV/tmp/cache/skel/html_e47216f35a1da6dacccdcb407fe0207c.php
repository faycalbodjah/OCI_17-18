...
recuperer_fond( 'inclure/documents' , array_merge($Pile[0],array('id_article' => $Pile[$SP]['id_article'] ,
	'id_rubrique' => '' )), array('compil'=>array('squelettes-dist/article.html','html_e47216f35a1da6dacccdcb407fe0207c','_principale',37,$GLOBALS['spip_lang'])), _request('connect')) .
'
...
// Temps de compilation total: 56.003 ms
//
