...
// Temps de compilation total: 26.002 ms
//
...
' .
	...
	' .
		...
		'
	' .
		recuperer_fond( 'formulaires/inc-forum_ajouter_mot' , array('ajouter_mot' => @$Pile[0]['ajouter_mot'] ), array('compil'=>array('plugins-dist/forum/formulaires/forum.html','html_58e8d3b5afb5f6b999cf8e7159a0c9c0','',15,$GLOBALS['spip_lang'])), _request('connect')) .
		'
	') . $t2 . '
	</div>
</form>') :
...
?'.'>
	...
	'ajouter_mot' => @$Pile[0]['ajouter_mot'] ), array('compil'=>array('plugins-dist/forum/formulaires/forum.html','html_58e8d3b5afb5f6b999cf8e7159a0c9c0','',34,$GLOBALS['spip_lang'])), _request('connect'))))!=='' ?
