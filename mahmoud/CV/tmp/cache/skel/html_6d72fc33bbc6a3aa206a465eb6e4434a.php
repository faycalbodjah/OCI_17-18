...
function BOUCLE_lienshtml_6d72fc33bbc6a3aa206a465eb6e4434a(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	if (!isset($command['table'])) {
		...
		$command['select'] = array("documents_liens.id_objet",
...
FROM spip_documents_liens as oooo)':'', 
	...
	$iter = IterFactory::create(
		"SQL",
		$command,
		array('../plugins-dist/medias/prive/squelettes/inclure/mediatheque-galerie.html','html_6d72fc33bbc6a3aa206a465eb6e4434a','_galerie',4,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
...
// Temps de compilation total: 72.504 ms
//
