...
function BOUCLE_sthtml_5f9a61b0ca4dc1b64d63ae7f334d5164(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	$iter = IterFactory::create(
		"DATA",
		$command,
		array('../prive/squelettes/contenu/auteurs.html','html_5f9a61b0ca4dc1b64d63ae7f334d5164','_st',4,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
	$SP++;
	// RESULTATS
...
'</li>
	...
	AND 1000*($timer = (time()+(float)microtime())-$timer) > _BOUCLE_PROFILER)
		spip_log(intval(1000*$timer)."ms BOUCLE_st @ ../prive/squelettes/contenu/auteurs.html","profiler"._LOG_AVERTISSEMENT);
	return $t0;
}
...
function html_5f9a61b0ca4dc1b64d63ae7f334d5164($Cache, $Pile, $doublons = array(), $Numrows = array(), $SP = 0) {
...
(($t1 = BOUCLE_sthtml_5f9a61b0ca4dc1b64d63ae7f334d5164($Cache, $Pile, $doublons, $Numrows, $SP))!=='' ?
		((	'
...
executer_balise_dynamique('FORMULAIRE_RECHERCHE_ECRIRE',
	array(self(),'ajax'),
	array('../prive/squelettes/contenu/auteurs.html','html_5f9a61b0ca4dc1b64d63ae7f334d5164','',16,$GLOBALS['spip_lang'])) .
...
');
	...
	return analyse_resultat_skel('html_5f9a61b0ca4dc1b64d63ae7f334d5164', $Cache, $page, '../prive/squelettes/contenu/auteurs.html');
}
?>